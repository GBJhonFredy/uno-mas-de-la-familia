<template>
  <section class="max-w-6xl mx-auto px-4 py-16 text-center fade-in relative">
    ...
    <div v-if="loading" class="flex flex-col items-center justify-center text-slate-500 py-10 animate-pulse">
    ...
    <div v-else-if="!proveedores.length" role="status" aria-live="polite"
      class="rounded-2xl ph-empty text-center p-8 max-w-full mx-auto z-10 relative bg-[aliceblue]">
      <div class="mb-6">
        <div
