  ...
  <transition name="fade">
    ...
    >
      ...
      >
        ...
        <!-- Tabla de edición -->
        <table class="w-full text-sm border border-[#FFE1B0] rounded-2xl overflow-hidden">
            ...
            <tr class="border-t border-[#FFE1B0] hover:bg-[#FFF8F2] transition">
              ...
              <td class="p-3">
                <input
                  v-model="form.title"
                  type="text"
                  class="w-full bg-white border border-[#E3B991]/60 rounded-lg px-2 py-1 outline-none focus:ring-2 focus:ring-[#E87C2A]/40 text-[#3B2C20]"
                />
              </td>
              <td class="p-3">
                <input
              ...
              <td class="p-3 text-center">
                <div class="flex justify-center items-center gap-2">
                  <span class="text-xs font-medium text-[#3B2C20]">
                    {{ form.published ? 'Sí' : 'No' }}
                  </span>
